...
| 小节 | 主要使用方 |
| --- | --- |
| [赛题理解与子问题识别](#赛题理解与子问题识别) | `analysis-modeling` |
| [假设与模型建立](#假设与模型建立) | `analysis-modeling` |
| [题型防错速查](#题型防错速查) | `analysis-modeling` `coding-visual` |
| [代码实现与结果](#代码实现与结果) | `coding-visual` |
| [编码阶段常见错误](#编码阶段常见错误) | `coding-visual` |
| [图表与可视化](#图表与可视化) | `coding-visual` `4drawio` `paper-writing` |
| [非数据图工具选择](#非数据图工具选择) | `4drawio` `paper-writing` |
| [论文写作](#论文写作) | `paper-writing` |
| [论文验收与一致性](#论文验收与一致性) | `6verity` |
| [模型大分类与选型速查](#模型大分类与选型速查) | `analysis-modeling` |
| [评价类模型详细指南](#评价类模型详细指南) | `analysis-modeling` `coding-visual` |
| [预测类模型详细指南](#预测类模型详细指南) | `analysis-modeling` `coding-visual` |
| [优化类模型详细指南](#优化类模型详细指南) | `analysis-modeling` `coding-visual` |
| [机理/动力学类模型详细指南](#机理动力学类模型详细指南) | `analysis-modeling` `coding-visual` |
| [图论与网络类模型](#图论与网络类模型) | `analysis-modeling` `coding-visual` |
| [统计分析与机器学习](#统计分析与机器学习) | `analysis-modeling` `coding-visual` |
| [论文写作规范补充](#论文写作规范补充) | `paper-writing` |
| [美赛（MCM/ICM）专项规范](#美赛mcmicm专项规范) | `paper-writing` |
